                ...
                <div className="px-8 pt-6 pb-2 shrink-0">
                    <div className="bg-[#fdf2f6] p-1.5 rounded-xl inline-flex border border-[#f2d8e4]">
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeTab === 'b2b' ? 'bg-white text-[#59112e] shadow-sm' : 'text-[#6b4c59] hover:text-[#59112e]'
                                }`}
                        >
                            <Building2 size={16} />
                            B2B Requests
                        ...
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeTab === 'b2c' ? 'bg-white text-[#59112e] shadow-sm' : 'text-[#6b4c59] hover:text-[#59112e]'
                                }`}
                        >
                            <ShoppingBag size={16} />
                            Consumer Orders
                        ...
                        {(activeTab === 'b2b' ? b2bRequests : b2cRequests).map((req) => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                                    ...
                                    {/* Icon / Avatar */}
                                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-xl font-bold shrink-0 ${activeTab === 'b2b' ? 'bg-[#fdf2f6] text-[#59112e]' : 'bg-emerald-50 text-emerald-600'
                                        }`}>
